...
dateFormat:"yy-mm-dd :",onSelect:function(t){let r=e(this).attr("value").split(" ");t.indexOf(" :")>-1&&(t=t.substring(0,t.length-2)),r[1]&&(t=t+" "+r[1]),e(this).val(t)}}),
/***************************************************************************************************
...
t.on("change.select2",(()=>{let e=t.select2("data").length<1;r.prop("disabled",e),e?a.addClass("student-search-empty"):a.removeClass("student-search-empty")}));
// For mobile devices (below 783px) put the filters and bulk actions below the table, else keep above.
let n=e(".tablenav.top > .sensei-student-bulk-actions__wrapper").first(),o=e(".tablenav.bottom > .tablenav-pages"),s=e(".tablenav.top > .tablenav-pages"),i=e("#woothemes-sensei"),d=()=>{let t=e(window).width(),r=t<783?o:s,a=t<783?"inherit":"";r.has(n).length||(r.before(n),i.css({position:a}))};d(),e(window).resize(d),
/***************************************************************************************************
