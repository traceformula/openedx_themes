...
var i=e("#bulk-edit"),s=new Array;
// get the selected post ids that are being edited
i.find("#bulk-titles-list button").each((function(){s.push(e(this).attr("id").replace(/^(_)/i,""))}));
// get the data:
//security as the wordpress nonce
var n=e('input[name="_edit_lessons_nonce"]').val(),t=i.find("#sensei-edit-lesson-course").val(),d=i.find("#sensei-edit-lesson-complexity").val(),a=i.find("#sensei-edit-lesson-pass-required").val(),_=i.find("#sensei-edit-quiz-pass-percentage").val(),l=i.find("#sensei-edit-enable-quiz-reset").val(),o=i.find("#sensei-edit-show-questions").val(),r=i.find("#sensei-edit-random-question-order").val(),u=i.find("#sensei-edit-quiz-grade-type").val();
