...
return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(e.DropdownMenu,{icon:r/* ["default"] */.A,label:(0,o.__)("Select an action","sensei-lms"),controls:g}),p&&y]})};Array.from(document.getElementsByClassName("student-action-menu")).forEach((e=>{(0,s.render)((0,a.jsx)(l,{studentId:e?.dataset?.userId,studentName:e?.dataset?.userName,studentDisplayName:e?.dataset?.userDisplayName}),e)}))})()})
/******/();