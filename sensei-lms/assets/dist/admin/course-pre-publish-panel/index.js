...
/******/var e={
/***/2192:
/***/(e,r,n)=>{var o=n(51609),s=Symbol.for("react.element"),t=Symbol.for("react.fragment"),l=Object.prototype.hasOwnProperty,i=o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,c={key:!0,ref:!0,__self:!0,__source:!0};
/**
 * @license React
 ...
 */function a(e,r,n){var o,t={},a=null,p=null;for(o in void 0!==n&&(a=""+n),void 0!==r.key&&(a=""+r.key),void 0!==r.ref&&(p=r.ref),r)l.call(r,o)&&!c.hasOwnProperty(o)&&(t[o]=r[o]);if(e&&e.defaultProps)for(o in r=e.defaultProps)void 0===t[o]&&(t[o]=r[o]);return{$$typeof:s,type:e,key:a,ref:p,props:t,_owner:i.current}}r.jsx=a}
/***/,
/***/3582:
...
/* harmony export */A:()=>u
/* harmony export */});
/* unused harmony export CoursePrePublishPanel */
/* harmony import */var o=n(27723),s=n(3582),t=n(14309),l=n(43656),i=n(56427),c=n(48597),a=n(62540);
/* harmony import */
/**
 ...
 */
const p=l.PluginPrePublishPanel||t.PluginPrePublishPanel,u=()=>{const[e,r]=(0,s.useEntityProp)("postType","course","meta"),{sensei_course_publish_lessons:n}=e;
return(0,a.jsx)(p,{title:(0,o.__)("Sensei LMS","sensei-lms"),icon:(0/* ["default"] */,a.jsx)(c.A,{height:"20",width:"20"}),initialOpen:!0,children:(0,a.jsx)(i.ToggleControl,{label:(0,o.__)("Publish lessons","sensei-lms"),help:(0,o.__)("Publish lessons when the course is published.","sensei-lms"),checked:n,onChange:n=>r({...e,sensei_course_publish_lessons:n})})})};
/**
...
/******/;
/* harmony import */var o=n(92279),s=n(11148);
/* harmony import */
/**
 * WordPress dependencies
 */
 ...
 * Internal dependencies
 */
(0,o.registerPlugin)("sensei-course-pre-publish-panel-plugin",{render:s/* ["default"] */.A,icon:null})})
/******/();